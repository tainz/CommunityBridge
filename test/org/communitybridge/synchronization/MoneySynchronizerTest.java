...
public class MoneySynchronizerTest
{
	...
	@Test
	public void synchronizeWithPositiveGameChangeShouldUpdateWeb()
	{
		...
		Mockito.verify(webApplication).setBalance(Mockito.eq(USER_ID),
																							AdditionalMatchers.eq(expected, DOUBLE_DELTA));
	}

	@Test
	public void synchronizeWithNegativeGameChangeShouldUpdateWeb()
	{
		double mcCurrent = RandomUtils.nextDouble();
